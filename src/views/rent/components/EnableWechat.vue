<template>
  <div>
  <el-dialog class='device-detail-container' top='4vh' width='80%' :close-on-click-modal=false title="启用规则" :visible="visible" @update:visible="$emit('update:visible', $event)">
    <p>规则基本信息</p>
    <div class="flex mb20">
