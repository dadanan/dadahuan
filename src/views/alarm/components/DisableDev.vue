<template>
  <div>
  <el-dialog class='device-detail-container' top='4vh' width='80%' :close-on-click-modal=false title="禁用场地" :visible="visible" @update:visible="$emit('update:visible', $event)">
    <p>设备主基本信息</p>
    <div class="flex mb20">
