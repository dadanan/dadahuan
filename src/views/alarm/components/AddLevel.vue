<template>
  <div>
  <el-dialog class='device-detail-container' top='4vh' width='55%' :close-on-click-modal=false title="添加加盟商" :visible="visible" @update:visible="$emit('update:visible', $event)">
    <p>加盟商基本信息</p>
    <div class="flex mb20">
    ...
    <div class="btn">
      ...
      <el-button type="primary" @click="ass">确认添加</el-button>
    </div>
  </el-dialog>
  </div>
</template>
