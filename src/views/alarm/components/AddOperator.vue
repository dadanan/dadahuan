<template>
  <div>
  <el-dialog class='device-detail-container' top='4vh' width='95%' :close-on-click-modal=false title="添加总监" :visible="visible" @update:visible="$emit('update:visible', $event)">
    <p>总监基本信息</p>
    <div class="flex mb20">
            ...
            <el-row :gutter="20">
              <el-col :span="8">
                <el-form-item label="总监名称 :">
                  <el-select v-model="form.registerNo" placeholder="请选择">
            ...
            <el-row :gutter="20">
              <el-col :span="12">
                <el-form-item label="业务相关人(内):">
                  <el-input v-model="form.referrer1" placeholder="请输入内容"></el-input>
                </el-form-item>
              </el-col>
            </el-row>
          </el-form>
    ...
    <div class="btn">
      ...
      <el-button type="primary" @click="addPartners">确认添加</el-button>
    </div>
  </el-dialog>
  </div>
</template>
